...
const itContractFavoriteResturantModel = (favoriteRestaurant) => {
  it('should return the resturant that has been added', async () => {
...
export default itContractFavoriteResturantModel;
